 ...
 *      - ADT(abstract data type), where primtives = abstraction barrier
 * (2) combinations (combinational operations) e.g) add, multiply...
 * get - 값을 받을 때, set - 값을 바꿀 때
 */
public class Fractional extends Number{ //name space, 의미를 간추리기 위해서 만듦 = 연산을 붙여놓은 이름 - static typing 
